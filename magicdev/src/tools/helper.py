...
def display_commands():
    commands = [
        ...
        {"Command": "search [keyword]", "Description": "Give back list of contacts by keyword (phone, name etc) with partial coincidence."},
        ...
        {"Command": "find-note [title]", "Description": "Find a note by title."},
        {"Command": "search-note [keyword]", "Description": "Give back list of notes by keyword (tag or title) with partial coincidence."},
